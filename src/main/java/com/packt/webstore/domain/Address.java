...
/**
 * The class Address represents customer address information
 * @author Joanna Stecz / j.stecz@wp.pl
 * @author Dorota Jankowiec / dorota.jankowiec@gmail.com
 * @version 1.0
 */
public class Address implements Serializable{
// interfejs Serializable służy on do pokazania wirtualnej maszynie, że instancje danej klasy implementującej ten interfejs 
//mogą być serializowane.
